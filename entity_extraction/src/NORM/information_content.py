...
def generate_ic_file(annotations, ontology_graph, ont_number):
    """Generate file with information content of all DeCS entities appearing in candidates files."""
    ...
    for doc in os.listdir(candidates_dir): 
        ...
        for line in data.split('\n'):
            ...
            if url in url_temp:
                ...
                if url != "" and "/" in url: #Only consider DeCS codes   
                    url_temp.append(url)
